...
namespace SenLib.Sen2 {
	public static class Sen2KnownFiles {
		...
		private static KnownFile[] InitKnownFiles() {
			...
			new KnownFile(new SHA1(0xd0a9a39e3aa04d57ul, 0x3b9a7b51a170fb1dul, 0xc4d79f17u), "data/scripts/scena/dat_us/e7050.dat"),
			...
			new KnownFile(new SHA1(0x1e88dbcff39609faul, 0xcaaca7a298032477ul, 0x39ff1f14u), "data/scripts/talk/dat_us/tk_heinrich.dat"),
			new KnownFile(new SHA1(0x836140611baf2149ul, 0xc7ac1a28182762b2ul, 0x5354b54fu), "data/scripts/talk/dat_us/tk_monica.dat"),
