...
namespace SenLib.Sen3 {
	public class Sen3Mods {
		...
		public static List<FileMod> GetAssetMods(bool allowSwitchToNightmare = false) {
			...
			f.Add(new FileFixes.alchr022_dat());
			f.Add(new FileFixes.t3400_dat());
			f.Add(new FileFixes.t3510_dat());
			f.Add(new FileFixes.t3600_dat());
			f.Add(new FileFixes.c2430_dat());
			f.Add(new FileFixes.c2440_dat());
			f.Add(new FileFixes.c2610_dat());
			f.Add(new FileFixes.c3000_dat());
			f.Add(new FileFixes.r2290_dat());
			f.Add(new FileFixes.t0000_dat());
			f.Add(new FileFixes.t0080_dat());
			f.Add(new FileFixes.r3000_dat());
			f.Add(new FileFixes.r3200_dat());
			f.Add(new FileFixes.tk_ada_dat());
			f.Add(new FileFixes.tk_linde_dat());
			f.Add(new FileFixes.tk_stark_dat());
			f.Add(new FileFixes.tk_tovar_dat());
			...
			f.Add(new FileFixes.book05_dat());
			f.Add(new FileFixes.book06_dat());
			return f;
		}
	}
}
