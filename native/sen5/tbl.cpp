...
static void WriteItemData(const ItemData& d, HyoutaUtils::Stream::MemoryStream& ms) {
    ...
    ms.WriteUInt32(std::bit_cast<uint32_t>(d.STR));
    ms.WriteUInt32(std::bit_cast<uint32_t>(d.DEF));
    ms.WriteUInt32(std::bit_cast<uint32_t>(d.ATS));
    ms.WriteUInt32(std::bit_cast<uint32_t>(d.ADF));
    ms.WriteUInt32(std::bit_cast<uint32_t>(d.ACC));
    ms.WriteUInt32(std::bit_cast<uint32_t>(d.EVA));
    ms.WriteUInt32(std::bit_cast<uint32_t>(d.SPD));
    ms.WriteUInt32(std::bit_cast<uint32_t>(d.MOV));
    ms.WriteUInt32(std::bit_cast<uint32_t>(d.HP));
    ms.WriteUInt32(std::bit_cast<uint32_t>(d.EP));
