...
bool TryApply(const SenPatcher::GetCheckedFileCallback& getCheckedFile,
    ...
    try {
        ...
        // imperial command."
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v00_e0427, PatchLength_v00_e0427);
            if (!d) {
                return false;
            }
            result.emplace_back(
        ...
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v00_e1032, PatchLength_v00_e1032);
            if (!d) {
                return false;
            }
            result.emplace_back(
        ...
        // they...)"
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v00_e1054, PatchLength_v00_e1054);
            if (!d) {
                return false;
            }
            result.emplace_back(
        ...
        // you, Your Highness."
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v00_s0081, PatchLength_v00_s0081);
            if (!d) {
                return false;
            }
            result.emplace_back(
        ...
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v00_s0264, PatchLength_v00_s0264);
            if (!d) {
                return false;
            }
            result.emplace_back(
        ...
        // {
        //     auto d = SenLib::DecompressFromBuffer(PatchData_v07_e0026, PatchLength_v07_e0026);
        //     if (!d) {
        //         return false;
        //     }
        //     result.emplace_back(
        ...
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v20_e0066, PatchLength_v20_e0066);
            if (!d) {
                return false;
            }
            result.emplace_back(
        ...
        // this."
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v27_e0042, PatchLength_v27_e0042);
            if (!d) {
                return false;
            }
            result.emplace_back(
        ...
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v31_e0070, PatchLength_v31_e0070);
            if (!d) {
                return false;
            }
            result.emplace_back(
        ...
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v43_e0023, PatchLength_v43_e0023);
            if (!d) {
                return false;
            }
            result.emplace_back(
        ...
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v49_e0004, PatchLength_v49_e0004);
            if (!d) {
                return false;
            }
            result.emplace_back(
        ...
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v52_e0109, PatchLength_v52_e0109);
            if (!d) {
                return false;
            }
            result.emplace_back(
        ...
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v52_e0119, PatchLength_v52_e0119);
            if (!d) {
                return false;
            }
            result.emplace_back(
        ...
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v55_e0018, PatchLength_v55_e0018);
            if (!d) {
                return false;
            }
            result.emplace_back(
        ...
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v55_e0062, PatchLength_v55_e0062);
            if (!d) {
                return false;
            }
            result.emplace_back(
        ...
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v56_e0080, PatchLength_v56_e0080);
            if (!d) {
                return false;
            }
            result.emplace_back(
        ...
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v56_e0092, PatchLength_v56_e0092);
            if (!d) {
                return false;
            }
            result.emplace_back(
        ...
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v57_e0020, PatchLength_v57_e0020);
            if (!d) {
                return false;
            }
            result.emplace_back(
        ...
        // today."
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v64_e0040, PatchLength_v64_e0040);
            if (!d) {
                return false;
            }
            result.emplace_back(
        ...
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v72_e0005, PatchLength_v72_e0005);
            if (!d) {
                return false;
            }
            result.emplace_back(
        ...
        // slightly earlier
        // {
        //     auto d = SenLib::DecompressFromBuffer(PatchData_v72_e0006, PatchLength_v72_e0006);
        //     if (!d) {
        //         return false;
        //     }
        //     result.emplace_back(
        ...
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v72_e0011, PatchLength_v72_e0011);
            if (!d) {
                return false;
            }
            result.emplace_back(
        ...
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v72_e0012, PatchLength_v72_e0012);
            if (!d) {
                return false;
            }
            result.emplace_back(
        ...
        {
            auto d = SenLib::DecompressFromBuffer(PatchData_v93_e0300, PatchLength_v93_e0300);
            if (!d) {
                return false;
            }
            result.emplace_back(
