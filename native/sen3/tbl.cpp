...
static void WriteItemData(const ItemData& d, HyoutaUtils::Stream::MemoryStream& ms) {
    ...
    ms.WriteUInt16(std::bit_cast<uint16_t>(d.STR));
    ms.WriteUInt16(std::bit_cast<uint16_t>(d.DEF));
    ms.WriteUInt16(std::bit_cast<uint16_t>(d.ATS));
    ms.WriteUInt16(std::bit_cast<uint16_t>(d.ADF));
    ms.WriteUInt16(std::bit_cast<uint16_t>(d.ACC));
    ms.WriteUInt16(std::bit_cast<uint16_t>(d.EVA));
    ms.WriteUInt16(std::bit_cast<uint16_t>(d.SPD));
    ms.WriteUInt16(std::bit_cast<uint16_t>(d.MOV));
    ms.WriteUInt16(std::bit_cast<uint16_t>(d.HP));
    ms.WriteUInt16(std::bit_cast<uint16_t>(d.EP));
